...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await signup(formData); // Call signup with formData directly
      toast.success("Sign Up Successful");
    } catch (error) {
      // Handle errors appropriately (e.g., display error toast)
      console.error("Signup error:", error);
      toast.error( error.response.data.error ||"Sign Up Failed! Please check your details."); // Show error toast
    }
  };
  ...
  return (
    <div className="md:w-1/3 w-[80%] mx-auto my-16">
      ...
      <Link to="/login" ><p className='text-center mt-3'>Login</p></Link>
